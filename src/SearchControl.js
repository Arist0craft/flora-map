...
function buildSearсhLayout() {
  ...
  const SearchLayout = ymaps.templateLayoutFactory.createClass(
    ...
    <div class="map-search">
      <button class="map-search-search" id="map-search-search">
      ...
      <input id="map-search-input" type="text" placeholder="{{ options.placeholderContent }}">
      <button class="map-search-clear disable" id="map-search-clear">
        <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M0.528558 0.528327C0.820345 0.23654 1.29342 0.23654 1.58521 0.528327L15.4719 14.415C15.7637 14.7068 15.7637 15.1799 15.4719 15.4717C15.1801 15.7635 14.707 15.7635 14.4152 15.4717L0.528558 1.58498C0.236771 1.29319 0.236771 0.820114 0.528558 0.528327Z" fill="#B6B6B6"/>
          <path fill-rule="evenodd" clip-rule="evenodd" d="M15.4717 0.528327C15.1799 0.23654 14.7068 0.23654 14.415 0.528327L0.52834 14.415C0.236553 14.7068 0.236553 15.1799 0.52834 15.4717C0.820127 15.7635 1.29321 15.7635 1.58499 15.4717L15.4717 1.58498C15.7635 1.29319 15.7635 0.820114 15.4717 0.528327Z" fill="#B6B6B6"/>
        </svg>            
      </button>
    </div>
    `,
    {
      ...
      build: function () {
        ...
        this._elements = {
          ...
          button: this._getElement("map-search-search"),
          clear: this._getElement("map-search-clear"),
        };
      ...
      _createElementListeners: function () {
        ...
        this._elementListeners = {
          ...
          clear: domEventManager.group(e.clear),
        };
        ...
        this._elementListeners.clear.add("click", this._onClearInput, this);
      ...
      _onInputKeyPress: function (domEvent) {
        if (this._isClearButtonDisabled()) {
          this._enableClearButton();
        }
      ...
      /**
       * Логический флаг: видна ли кнопка очистки
       * @returns Флаг видна ли кнопка очистки
       */
      _isClearButtonDisabled: function() {
        return this._elements["clear"].classList.contains("disable");
      },

      /**
       * Включение кнопки очистки поля ввода
       */
      _enableClearButton: function() {
        this._elements["clear"].classList.remove("disable");
      },

      /**
       * Отключение кнопки очистки поля ввода
       */
      _disableClearButton: function() {
        this._elements["clear"].classList.add("disable");
      },
